...
Запрещено использовать ботов и другие автоматизированные средства для сбора, логирования, копирования, распространения или "пробива" данных пользователей (профилей, сообщений, списков и т.п.) с сервера. Все остальные боты разрешены. За нарушение — блокировка аккаунта; если считаете, что ошибся или не уверены, разрешен ли ваш бот — пишите в Telegram: [@denis0001_dev](https://t.me/denis0001_dev).
